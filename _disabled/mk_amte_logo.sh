...
FONT_URL="https://github.com/RedHatOfficial/Overpass/releases/download/v3.0.5/overpass-3.0.5.zip"
...
if [[ ! -f "$FONT_NAME" ]]; then
    ...
    mv "$FONT_DIR/Overpass-3.0.5/webfonts/overpass-webfont/overpass-heavy.ttf" "$FONT_NAME"
